...
const AnalyticsSearch = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Logic: User might paste "https://short.ly/abc12" or just "abc12"
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10 text-center">
        ...
        <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">Track Your Link</h1>
        <p className="text-zinc-400 text-lg mb-10">
          Paste your short URL to see real-time clicks and data.
        </p>

        <div className="glass-panel p-2 rounded-2xl flex items-center shadow-2xl shadow-black/50">
          ...
          <form onSubmit={handleSearch} className="flex-1 flex">
            <input 
              type="text" 
              placeholder="Paste URL (e.g. https://shorttheurl-qawf.onrender.com/ABC12)" 
              value={input}
            ...
            <button 
              type="submit"
              className="m-1 px-6 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-medium transition-all flex items-center gap-2"
            >
              <span>View</span>
